...
export default function Home() {
  ...
  const [data, loading] = useApi(getHomeDetails)
    ...
    <div className="home-container">
      ...
      >
        ...
        >
          ...
          >
            <Grid mb={20} item xs={12}>
              <VipCard
                title="Message from Jhon Doe"
            ...
            <Grid mt={8} item xs={12} sm={10} md={10} className="px-0">
              <Schedule data={data.schedule}></Schedule>
            </Grid>
            ...
            >
              ...
              <Grid item xs={12} md={4}>
                <NavigationCards
                  ...
                  title="Tourism"
                  subTitle="Things to add to your bucket list"
                  route={ROUTE_TOURISM}
              ...
              <Grid item xs={12} md={4}>
                <NavigationCards
                  ...
                  title="Hotels"
                  subTitle="Checkout the list of HomeStays and Hotels in Dima Hasao and Umrangso"
                  route={ROUTE_HOTELS}
                  icon={<HotelIcon />}
                />
              </Grid>
              <Grid item xs={12} md={4}>
                <NavigationCards
                  ...
                  title="Food"
                  subTitle="Delicacies to try out while on the trip"
                  route={ROUTE_FOOD}
                />
              </Grid>
            </Grid>
